...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn(
      "flex w-full h-10 items-center justify-between rounded-md p-0 text-sm outline-none transition-shadow",
      "bg-[var(--color-card)] text-[var(--color-foreground)] border border-[var(--color-border)]",
      "hover:border-[var(--color-primary)]",
      "has-[[data-slot=input-group-control]:focus-visible]:ring-[2px] has-[[data-slot=input-group-control]:focus-visible]:ring-[var(--ring)]",
      "has-[[data-slot=input-group-control]:focus-visible]:ring-offset-2 has-[[data-slot=input-group-control]:focus-visible]:ring-offset-[var(--color-background)]",
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        ...
        "rounded-sm py-1.5 pr-2 pl-4 text-sm outline-none",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        "data-highlighted:bg-[var(--color-primary)] data-highlighted:text-[var(--color-primary-foreground)]",
        className
      )}
      {...props}
    >
